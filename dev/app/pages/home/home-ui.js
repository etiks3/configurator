...
<Rojas>
  * @Date: 16-02-2017 * @Project: Configurator * @Filename: home-ui.js * @Last modified by: sylvain * @Last modified time:
  2017-03-26T18:20:18+02:00 * @Copyright: S.Rojas */ export function homeSkeleton() { return `
...
<!-- MAIN  -->
    <section id="shelter">
      ...
      <p>Pour configurer votre abris,
        <br/> veuillez appuyer sur le marqueur vert en bas à gauche de l'écran
        <p>
          <div class="choice1 ">
            <button id="foundation-marker" class="marker1 btn-floating btn-large"><i class="material-icons">add</i></button>
